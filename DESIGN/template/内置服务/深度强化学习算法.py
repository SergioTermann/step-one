...
def main():
    ...
    parser = argparse.ArgumentParser(description='深度强化学习算法 - HTTP状态上报版本')
    ...
    algorithm_info = {
        ...
        "version": "1.0",
        "creator": "system",
        "description": "深度强化学习算法，用于智能决策和策略优化",
        "inputs": [
            {"name": "状态空间", "symbol": "state", "type": "array", "dimension": 1, "description": "环境状态向量"},
            {"name": "奖励信号", "symbol": "reward", "type": "float", "dimension": 1, "description": "环境反馈奖励"}
        ],
        "outputs": [
            {"name": "动作", "symbol": "action", "type": "array", "dimension": 1, "description": "智能体选择的动作"},
            {"name": "价值函数", "symbol": "value", "type": "float", "dimension": 1, "description": "状态价值估计"}
        ],
        "network_info": {
            "port": args.algo_port,
            "status": "运行中"
