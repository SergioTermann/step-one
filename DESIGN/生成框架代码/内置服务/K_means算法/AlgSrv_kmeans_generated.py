...
def main():
    ...
    config_param = "{'new_algo_name': 'template', 'category': '内置服务', 'subcategory': '聚类分析类', 'version': '1.3', 'creator': '陈五', 'create_time': '2025/1/10 09:15', 'maintainer': '陈五', 'update_time': '2025-04-05 09:11:03', 'description': 'K-means算法是一种常用的聚类分析算法，旨在将数据点分为K个簇，使得每个点都属于距离最近的簇。', 'inputs': [{'name': '惯性数据', 'symbol': 'IMU', 'type': 'double', 'dimension': 'mxn', 'description': 'mxn'}, {'name': 'GPS数据', 'symbol': 'GPS', 'type': 'double', 'dimension': 'px3', 'description': 'GPS位置数据'}, {'name': '图像地址', 'symbol': 'img_path', 'type': 'int8', 'dimension': '1', 'description': '图像文件路径'}, {'name': '时间戳', 'symbol': 't', 'type': 'vector', 'dimension': 'qx1', 'description': '数据采集时间戳'}, {'name': '簇数量', 'symbol': 'K', 'type': 'std::vector<int>', 'dimension': '1', 'description': '期望的聚类数量'}], 'outputs': [{'name': '物体类别标签', 'symbol': 'labels', 'type': 'vector', 'dimension': 'mx1', 'description': '识别的物体类别标签'}, {'name': '物体绝对位置', 'symbol': 'positions', 'type': 'double', 'dimension': 'mx3', 'description': '各物体的绝对位置坐标'}, {'name': '物体加速度', 'symbol': 'accel', 'type': 'double', 'dimension': 'mx3', 'description': '各物体的加速度'}, {'name': '置信度', 'symbol': 'confidence', 'type': 'vector', 'dimension': 'mx1', 'description': '各物体识别的置信度'}], 'name': 'K_means算法', 'english_name': 'kmeans'}"
