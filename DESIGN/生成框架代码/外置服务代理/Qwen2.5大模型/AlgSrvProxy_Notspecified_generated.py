...
class AlgSrvProxy_Notspecified:
...
def main():
    ...
    config_param = "{'category': '外置服务代理', 'class': '大模型类', 'subcategory': '大型语言模型', 'version': '2.5', 'creator': '阿里云', 'create_time': '2025/1/1 00:00', 'maintainer': '阿里云团队', 'update_time': '2025/2/15 00:00', 'description': 'Qwen2.5是一个大规模预训练语言模型，能够执行自然语言处理、推理、规划和决策辅助等任务。', 'inputs': [{'name': '提示词', 'symbol': 'prompt', 'type': '字符串', 'dimension': '1', 'description': ''}, {'name': '系统信息', 'symbol': 'system', 'type': '字符串', 'dimension': '1', 'description': '系统角色设定和任务描述'}, {'name': '历史对话', 'symbol': 'history', 'type': 'list', 'dimension': '1', 'description': '之前的对话历史记录'}], 'outputs': [{'name': '回复内容', 'symbol': 'response', 'type': 'str', 'dimension': '1', 'description': '模型生成的回复内容'}, {'name': '置信度', 'symbol': 'confidence', 'type': 'int', 'dimension': '1', 'description': '模型对回复内容的置信度'}], 'network_info': {'ip': '127.0.0.1', 'status': '空闲', 'is_remote': False}}"
    ...
    algorithm = AlgSrvProxy_Notspecified()
